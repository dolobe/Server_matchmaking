...
class Statistic(models.Model):
    ...
    ia_wins = models.IntegerField(default=0)
    ia_loses = models.IntegerField(default=0)
    ia_draws = models.IntegerField(default=0)
    ia_wins_facile = models.IntegerField(default=0)
    ia_loses_facile = models.IntegerField(default=0)
    ia_draws_facile = models.IntegerField(default=0)
    ia_wins_moyen = models.IntegerField(default=0)
    ia_loses_moyen = models.IntegerField(default=0)
    ia_draws_moyen = models.IntegerField(default=0)
    ia_wins_difficile = models.IntegerField(default=0)
    ia_loses_difficile = models.IntegerField(default=0)
    ia_draws_difficile = models.IntegerField(default=0)
